...
function App(){
    ...
    return(
        <div id="main">
          ...
          {flag?<p>Please Enter valid input</p>:null}
          {size % 6 ==1?<h3>Friends</h3>:size%6 == 2?<h3>Love</h3>:size % 6 ==3?<h3>Affection</h3>:size % 6 ==4?<h3>Marriage</h3>:size % 6 ==5?<h3>Enemy</h3>:size % 6 ==0?<h3>Siblings</h3>:null}
        </div>)
}
